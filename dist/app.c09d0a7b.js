...
window.onload = function () {
  var listings = document.querySelector('listings'); //loop through listings

  listings.forEach(function (listing) {
    return handleSlider(listing);
  });
}; // function for handle slider


var handleSlider = function handleSlider(listing) {
  var listingsGrid = listing.querySelectorAll('listings-grid')[0];
  var arrowLeft = listing.querySelectorAll('left')[0];
  var arrowRight = listing.querySelectorAll('right')[0]; // error checking
  ...
  var classChange = function classChange(direction) {
    if (direction == 'right') {
